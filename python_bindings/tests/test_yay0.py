...
def test_matching_decompression(bin_data: bytes, comp_data: bytes) -> bool:
    ...
    decompressed = crunch64.decompress_yay0(comp_data)
    print(" OK")
...
def test_matching_compression(bin_data: bytes, comp_data: bytes) -> bool:
    ...
    compressed = crunch64.compress_yay0(bin_data)
    print(" OK")
...
def test_cycle_decompressed(bin_data: bytes) -> bool:
    ...
    print("    Decompressing: ", end="")
    dec = crunch64.decompress_yay0(compressed)
    print(" OK")
...
def test_cycle_compressed(comp_data: bytes) -> bool:
    ...
    print("    Decompressing: ", end="")
    dec = crunch64.decompress_yay0(comp_data)
    print(" OK")

    print("    Compressing: ", end="")
    compressed = crunch64.compress_yay0(dec)
    print(" OK")
...
errors = 0
for comp_path in Path("test_data").glob("*.Yay0"):
