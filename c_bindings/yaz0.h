 ...
 */
bool crunch64_decompress_yaz0_bound(size_t *dst_size, size_t src_len, const uint8_t *const src);
 ...
 */
bool crunch64_compress_yaz0_bound(size_t *dst_size, size_t src_len, const uint8_t *const src);
