 ...
 * refer to `crunch64_decompress_yaz0_get_dst_buffer_size`.
 *
 ...
 */
bool crunch64_compress_yaz0_get_dst_buffer_size(size_t *dst_size, size_t src_len, const uint8_t *const src);
 ...
 * refer to `crunch64_compress_yaz0_get_dst_buffer_size`.
 *
 * When this function is called, `dst_len` must point to the size of the `dst` pointer, allowing for range checking
 * and avoiding to write out of bounds.
 *
